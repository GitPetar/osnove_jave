...
public class Zadatak2 {
    public static void main(String[] args) {
        Kupac petar = new Kupac("Petar Kotevski");
        petar.setKartica(new Kartica());
        p10_01_2023.Proizvod proizvod = new Proizvod("Proizvod", 200);
        proizvod.setKupac(petar);
        proizvod.print();
    }
}
